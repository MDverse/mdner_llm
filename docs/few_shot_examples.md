## Training examples (Few-Shot demonstrations)
...
{"entities":
  [
    {"category": "MOL", "text": "DMPC"},
    {"category": "STIME", "text": "1 ns"},
    {"category": "MOL", "text": "DMPC"},
    {"category": "STEMP", "text": "310K"},
    {"category": "MOL", "text": "DMPC"},
    {"category": "FFM", "text": "GROMOS 54A7"},
    {"category": "FFM", "text": "SPC"},
    {"category": "MOL", "text": "AAAQAAQAQWAQRQATWQA"},
    {"category": "SOFTNAME", "text": "MDAnalysis"}
  ]
}
...
{"entities": 
  [
    ...
    {"category": "STIME", "text": "87 microsecond"},
    {"category": "MOL", "text": "alanine dipeptide"},
    {"category": "STEMP", "text": "300 K"},
    {"category": "FFM", "text": "AMBER99SB-ILDN"},
    {"category": "SOFTNAME", "text": "GROMACS"},
    {"category": "SOFTVERS", "text": "2021.4"},
    {"category": "SOFTNAME", "text": "COLVAR"},
    {"category": "MOL", "text": "Alanine dipeptide"}
  ]
}
...
{"entities":
  [
    {"category": "FFM","text": "GROMOS 43A1-S3"},
    {"category": "MOL","text": "POPE"},
    {"category": "STEMP","text": "313 K"},
    {"category": "FFM","text": "GROMOS 43A1-S3"},
    {"category": "MOL","text": "POPE"},
    {"category": "SOFTNAME","text": "GROMACS"},
    {"category": "SOFTVERS","text": "4.0.7"},
    {"category": "STIME","text": "200 ns"},
    {"category": "STEMP","text": "313 K"},
    {"category": "STIME","text": "100 ns"},
    {"category": "FFM","text": "GROMOS 43A1-S3"},
