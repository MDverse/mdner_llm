...
This folder contains Jupyter notebooks used for experimentation, annotation, and model development.

## Structure

### `utils/`
- [Annotate text with LLM](utils/annotate_text_with_llm.ipynb)
- [Visualize annotation from JSON file](utils/visualize_annotation_from_json_file.ipynb)
